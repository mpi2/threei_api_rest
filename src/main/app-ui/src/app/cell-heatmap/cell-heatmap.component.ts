  ...
  Highcharts = Highcharts;
    ...
    cellChartOptions = {
     ...
     series: [{
       ...
       borderWidth: 1,
       data: [[0, 0, 'blah'], [0, 1, 1]],
       // , [2, 0, 35], [2, 1, 15], [2, 2, 123], [2, 3, 64], [2, 4, 52], [3, 0, 72], [3, 1, 132], [3, 2, 114], 
      dataLabels: {
           enabled: false,
           color: '#000000'
       }
...
displayCellChart() {
  ...
  legend: {
    ...
    // symbolHeight: 280
      ...
      // "And second yAxis category here. <br/>" + "<span style=\"font-weight: bold; color:" +
      // this.series.color + "\">" + this.series.chart.yAxis[1].categories[this.y] + "</span><br/>" + "x value: " + this.point.x + "<br/>"
      //   },
      //   "useHTML": true
      // },
    ...
    this.heatmapService.defaultCellHeatmapChart = this.cellHeatmapChart;
    }
