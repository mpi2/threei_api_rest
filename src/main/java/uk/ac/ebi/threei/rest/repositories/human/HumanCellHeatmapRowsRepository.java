...
@RepositoryRestResource(collectionResourceRel = "HumanCellHeatmapRow", path = "humancellheatmaprows")
public interface HumanCellHeatmapRowsRepository extends  MongoRepository<CellHeatmapRow, String>{
